...
public class Example0 implements ActionListener {
  ...
  //  private JPanel controlPanel;
    ...
    public static void main(String[] args) {
        Example0 buttonPresser = new Example0();
   ...
   //     mainFrame.add(statusLabel);
    ...
    private void showEventDemo() {
        ...
        mainFrame.add(submittButton,BorderLayout.WEST);
        mainFrame.add(cancelttButton,BorderLayout.CENTER);
